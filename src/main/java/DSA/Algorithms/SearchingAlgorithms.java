...
public class SearchingAlgorithms {
    ...
    // Function to determine if an element exists in an unsorted array or not using Linear Search Algorithm
    ...
    // Function to determine if an element exists in a sorted array or not using Linear Search Algorithm
    ...
    // Function to determine if an element exists in a sorted array or not using Ternary Search Algorithm
